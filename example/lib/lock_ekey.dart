...
class LockeKeyPage extends StatefulWidget {
  LockeKeyPage(
      {Key? key,
      required this.title,
  ...
  final String lockId;
  @override
  _LockeKeyPageState createState() =>
      _LockeKeyPageState(lockData, lockMac, lockId);
}
...
class _LockeKeyPageState extends State<LockeKeyPage> {
  ...
  _LockeKeyPageState(String lockData, String lockMac, String lockId) {
    super.initState();
